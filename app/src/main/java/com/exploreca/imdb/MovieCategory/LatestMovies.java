 ...
 */
public class LatestMovies extends ListActivity {

    public static final String LOGGERSTR = "HELLO";
    public static final String API_VERSION = "3";
    public static final String CONTEXT_PATH = "movie/latest";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem item = menu.findItem(R.id.menu_latest);
...
//        menu.findItem(R.id.menu_latest).setVisible(true);
...
//            PlaceHolderFragment fragmentOne = new PlaceHolderFragment();
//            fragmentTransaction.add(R.id.layout, fragmentOne);
...
//    }
    ...
    private class MyTask extends AsyncTask<String, String, List<Movie>> {
        ...
        protected void onPostExecute(List<Movie> result) {
            ...
            if (result == null) {
                Toast.makeText(LatestMovies.this, "Web service not available", Toast.LENGTH_LONG).show();
                return;
            }
            movieList = result;
            updateDisplay();
